    ...
    render() {
     ...
     <ul className="set_colors">
       ...
       <li className="color_container">
         ...
         <input id="setcolors_green" onClick={() => this.props.changeColor(1)} type="radio" name="setcolors_option" checked={this.isColorSelected(1)} />
       </li>
       <li className="color_container">
         ...
         <input id="setcolors_red" onClick={() => this.props.changeColor(2)} type="radio" name="setcolors_option" checked={this.isColorSelected(2)} />
       </li>
       <li className="color_container">
         ...
         <input id="setcolors_blue" onClick={() => this.props.changeColor(3)} type="radio" name="setcolors_option" checked={this.isColorSelected(3)} />
       </li>
     </ul>
     <ul className="set_container">
       ...
       <div className="type_fonts_container">
         <li className="fonts_position">
           ...
           <input onClick={() => this.props.changeTypography(1)} className="selector_position" id="Ubuntu" type="radio" name="fonts_option" checked={this.isFontSelected(1)} />
         </li>
         <li className="fonts_position">
           <label className="list_item" htmlFor="ComicSans">Comic Sans</label>
           <input onClick={() => this.props.changeTypography(2)} className="selector_position" id="ComicSans" type="radio" name="fonts_option" checked={this.isFontSelected(2)} />
         </li>
         <li className="fonts_position">
           <label className="list_item" htmlFor="Montserrat">Montserrat</label>
           <input onClick={() => this.props.changeTypography(3)} className="selector_position" id="Montserrat" type="radio" value="Montserrat" name="fonts_option" checked={this.isFontSelected(3)} />
         </li>
       </div>
     </ul>
   </div>
